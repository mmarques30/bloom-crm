        ...
        <Tabs defaultValue="contatos">
          <TabsList className="pill mb-4 bg-muted">
            <Can permission="tab.clientes.contatos">
              <TabsTrigger value="contatos" className="pill">Contatos</TabsTrigger>
            </Can>
            <Can permission="tab.clientes.pipeline">
              <TabsTrigger value="pipeline" className="pill">Pipeline</TabsTrigger>
            </Can>
            <Can permission="tab.clientes.historico">
              <TabsTrigger value="historico" className="pill">Histórico</TabsTrigger>
            </Can>
          </TabsList>
